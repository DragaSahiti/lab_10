...
{     
     p1 = q1;
     p2 = q2;
  //llops to move the function of q1
         while (q1.Get_X()<p2.Get_X())
         {
           q1.Move(1,0);
         }
     p3 = q1;
  //loops to move the function of q2
         while (q2.Get_X()>p1.Get_X())
         {
           q2.Move(-1,0);
         }   
     p4 = q2;
     cout << "The third point of the rectangle and";
     p3.Print(p3.Get_X(),p3.Get_Y());
     cout << endl;
     cout << "The fourth point of the rectangle and";   
...
//Lab 7 exercise 4.1. Test member function print on points p1, p2:
  cout << "The first point of ";
  p1.Print(p1.Get_X(),p1.Get_Y());
  cout << endl;
  
  cout << "The second point of ";
  p2.Print(p2.Get_X(),p2.Get_Y());
  cout << endl;

//Lab 7 Exercises 4.2, 4.3. Testing of the class Rectangle goes here:
  cout<<"The 1st point of the rectangle and ";
  p1.Print(p1.Get_X(),p1.Get_Y());
  cout<<endl;
  
  cout<<"The 2nd point of the rectangle and ";
  p2.Print(p2.Get_X(),p2.Get_Y());
  cout<<endl;
